...
#  Remediation Workflows — deploy.sh
...
echo ""
echo -e "${BLD}  ── Remediation Workflows ──${RST}"
echo ""
...
# TODO: add any jamf-protect/remediation-workflows-specific variables here
...
if [ "$confirm" = "yes" ]; then
    ...
    echo ""
    echo -e "${GRN}  ✔ Remediation Workflows deployed successfully.${RST}"
else
