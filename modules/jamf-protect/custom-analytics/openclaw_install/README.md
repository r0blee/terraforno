...
This module creates a Custom Analytic within Jamf Protect that performs the detection of OpenClaw installation commands from openclaw.ai.
...
````bash
terraforno --module jamf-protect/custom-analytics/openclaw_install --profile prod --mode <deploy|export> --override <yes|no>
````