...
### module: jamf-protect/custom-analytics/openclaw_onboard

This module creates a Custom Analytic within Jamf Protect that performs the detection of OpenClaw Onboard command to initiate setup.
...
````bash
terraforno --module jamf-protect/custom-analytics/openclaw_onboard --profile prod --mode <deploy|export> --override <yes|no>
````