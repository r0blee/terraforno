...
echo ""
echo -e "${BLD}  ── Jamf Setup Manager ──${RST}"
echo ""
...
# TODO: add any jamf-setup-manager-specific variables here
...
if [ "$confirm" = "yes" ]; then
    ...
    echo ""
    echo -e "${GRN}  ✔ Jamf Setup Manager deployed successfully.${RST}"
else
