...
#  Jamf Setup Checklist — deploy.sh
#  Provider: Jamf Pro Terraform Provider
# ─────────────────────────────────────────

MODULE="jamf-pro/jamf-setup-checklist"
...
echo ""
echo -e "${BLD}  ── Jamf Setup Checklist ──${RST}"
echo ""
...
# TODO: add any jamf-setup-checklist-specific variables here
...
if [ "$confirm" = "yes" ]; then
    ...
    echo ""
    echo -e "${GRN}  ✔ Jamf Setup Checklist deployed successfully.${RST}"
else
