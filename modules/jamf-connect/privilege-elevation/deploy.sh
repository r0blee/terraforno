...
#  Configure Privilege Elevation — deploy.sh
#  Provider: Jamf Connect Terraform Provider
# ─────────────────────────────────────────

MODULE="jamf-connect/privilege-elevation"
WORK_DIR="/tmp/terraforno/jamf-connect/privilege-elevation"
...
echo ""
echo -e "${BLD}  ── Configure Privilege Elevation ──${RST}"
echo ""
...
# TODO: add any jamf-connect/privilege-elevation-specific variables here
...
if [ "$confirm" = "yes" ]; then
    ...
    echo ""
    echo -e "${GRN}  ✔ Configure Privilege Elevation deployed successfully.${RST}"
else
