...
# ─────────────────────────────────────────
# ── Module Info ─────────────────────────────
# APIs:   Jamf Security Cloud API
# Auth:   auth_jamf_security_cloud_oauth2
# ─────────────────────────────────────────────

#  Configure Access Policies — deploy.sh
...
echo ""
echo -e "${BLD}  ── Configure Access Policies ──${RST}"
echo ""
...
# ── Authentication ───────────────────────────
auth_jamf_security_cloud_oauth2

# TODO: add any jamf-connect/access-policies-specific variables here
...
if [ "$confirm" = "yes" ]; then
    ...
    echo ""
    echo -e "${GRN}  ✔ Configure Access Policies deployed successfully.${RST}"
else
